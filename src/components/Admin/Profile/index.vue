                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <label for="">{{ list_login.ten_nhan_vien }}</label>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <button v-if="list_login.tinh_trang == 1"
                                            v-on:click="Object.assign(edit_nhan_vien, list_login)"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-2">
                        ...
                        <input v-model="edit_nhan_vien.ten_nhan_vien" class="form-control rounded-pill" type="text">
                    </div>
                    <div class="mb-2">
                        <label>Email</label>
                        <input v-model="edit_nhan_vien.email" class="form-control rounded-pill" type="text">
                    </div>
                    <div class="mb-2">
                        <label>Số Điện Thoại</label>
                        <input v-model="edit_nhan_vien.so_dien_thoai" class="form-control rounded-pill" type="text">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal">Đóng</button>
                    <button v-on:click="capNhatNhanVien()" type="button" class="btn btn-primary rounded-pill"
...
export default {
    ...
    methods: {
        ...
        capNhatNhanVien() {
            axios
                .post("http://127.0.0.1:8000/api/nhan-vien/update", this.edit_nhan_vien, {
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("token_nhan_vien")
                    }
                })
        ...
        formatPhone_0xxx(phone) {
            ...
            return phone; // Trả lại nguyên bản nếu không đúng định dạng mong muốn
        }
